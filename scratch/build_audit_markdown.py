"""
scratch/build_audit_markdown.py
Generates docs/ml/HARDCORE_MODEL_AUDIT.md with full empirical rigor.
"""
...
v2_008 = d["v2_eval"]["calibrated_threshold_0.08"]
v2_050 = d["v2_eval"]["calibrated_threshold_0.50"]
b_rain30 = d["baselines"]["rain_24h_ge_30mm"]
b_rain50 = d["baselines"]["rain_24h_ge_50mm"]
b_tree3 = d["baselines"]["decision_tree_depth3"]
b_lr = d["baselines"]["simple_logistic_regression"]
b_stump = d["baselines"]["decision_stump_depth1"]
sp_hold = d["split_experiments"]["spatial_holdout_pandoh_dharampur"]
inv_aug = d["split_experiments"]["inverted_event_holdout_august2023"]
cv5 = d["split_experiments"]["random_5fold_cv_optimistic"]
b_ci = d["bootstrap_ci"]
lat = d["latency_benchmarks"]
reg = d["regional_models_audit"]
cross = d["cross_region_generalization"]
fatigue = d["alert_fatigue"]
calib = d["calibration"]
mono = d["monotonicity_and_physics"]
adv = d["adversarial_testing"]
abl = d["feature_ablation"]

md = f"""# FLOWSHIELD — HARDCORE ADVERSARIAL ML MODEL AUDIT
...
with open(REPO_ROOT / "docs" / "ml" / "HARDCORE_MODEL_AUDIT.md", "w", encoding="utf-8") as f:
    f.write(md)

print("Generated docs/ml/HARDCORE_MODEL_AUDIT.md successfully.")
