"""
ml/src/features/feature_definitions.py
Flowshield — Canonical Hydrological & Meteorological Feature Definitions (v2.5)
Smart India Hackathon 2026 (PS ID: 26192)

Single authoritative source of truth for the 15 physical features derived strictly
from verified ECMWF ERA5-Land reanalysis and DEM topographic attributes.
